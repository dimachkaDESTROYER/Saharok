...
namespace Saharok.Tests
{
    ...
    public class Player_Should
    {
        ...
        public void TestCoinAddToPlayerInGame()
        {
            ...
            var player = new Player(new Rectangle(50, 500, 100, 100));
            var level = new Level(1000, 800, walls, coins, water, 0, player, monsters, finish);
        ...
        public void TestIsWin()
        {
            ...
            var level = new Level(1000, 1000, walls, new List<Rectangle>(), water, 5, player, monsters, finish);
